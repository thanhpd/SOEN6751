      ...
      <Swiper
        ...
        renderCard={(trainer) => (
          <View style={styles.card}>
            <Image source={{ uri: trainer.profilePic }} style={styles.profilePic} />
            <Text style={styles.name}>{trainer.name}</Text>

            <View style={styles.infoContainer}>
              <FontAwesome5 name="certificate" size={16} color="#555" />
              <Text style={styles.infoText}>{trainer.certification}</Text>
            </View>

            <View style={styles.infoContainer}>
              <FontAwesome5 name="graduation-cap" size={16} color="#555" />
              <Text style={styles.infoText}>{trainer.education}</Text>
            </View>
          </View>
        )}
        onSwiped={(index) => {
