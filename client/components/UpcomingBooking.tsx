...
export default function UpcomingBookingCard({ bookingData }: { bookingData: BookingData }) {
  const { serviceName, customerName, bookingDate, startTime, endTime, status, image } = bookingData;
