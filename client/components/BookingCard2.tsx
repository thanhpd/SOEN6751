...
import FontAwesome5 from 'react-native-vector-icons/FontAwesome5' // Importing FontAwesome5 icons
...
export default function BookingCard2({
    ...
    return (
        <View style={styles.card}>
            {/* Image Above */}
            <Image
                source={require('@/assets/images/cycling-equipment-healthy-fit-fitness.jpg')}
